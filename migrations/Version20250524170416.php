 ...
 */
final class Version20250524170416 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE post CHANGE description description VARCHAR(160) NOT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE post CHANGE description description VARCHAR(255) NOT NULL
        SQL);
    }
}
