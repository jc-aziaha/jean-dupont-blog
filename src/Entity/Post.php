...
class Post
{
    ...
    public function isLikedBy(User $user): bool
    {
        ...
        foreach ($likes as $like) {
            // Si l'utilisateur qui a déjà liké l'article est le même que l'utilisateur connecté,
            if ($like->getUser() == $user) {
                // Alors, retourne true pour confirmer cela.
                return true;
            }
        }

        // Dans le cas contraire, après avoir parcouru tout le tableau, retourne false.
        return false;
    }
